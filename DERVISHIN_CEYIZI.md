...
```python
# Emare Token — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emare-token.view',      # Görüntüleme
    'emare-token.create',    # Oluşturma
    'emare-token.edit',      # Düzenleme
    'emare-token.delete',    # Silme
    'emare-token.manage',    # Tam yönetim
    # Admin
    'emare-token.admin',     # Admin panele erişim
    'emare-token.users',     # Kullanıcı yönetimi
    'emare-token.settings',  # Ayar yönetimi
]
```
...
```python
# emare-token/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emare-token.view', 'emare-token.create',
        'emare-token.edit', 'emare-token.delete',
        'emare-token.manage', 'emare-token.users',
        'emare-token.settings', 'emare-token.admin',
    },
    'operator': {
        'emare-token.view', 'emare-token.create',
        'emare-token.edit',
...
| Proje Admini | admin@emare-token.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emare-token.emare.dev | super_admin | Machine-to-machine |
