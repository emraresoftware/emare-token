...
> **Kapsam:** Emare Token projesindeki tüm yapay zekalar
...
Emare Token projesinde kod yazan her yapay zeka bu anayasaya uymak zorundadır.
...
4. emare-token_HAFIZA.md (proje hafızası)
...
1. `emare-token_HAFIZA.md` — Ne yapıldı, ne öğrenildi
