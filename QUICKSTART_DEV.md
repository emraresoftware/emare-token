# Emare Token — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/emare-token
...
| 6 | `emare-token_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `emare-token Dervishi` bu projeden sorumlu
